...
Web Development & HTML5, CSS3, JavaScript, Bootstrap, React.js \\

Backend Technologies & Node.js, REST APIs, API Integration \\

Database Technologies & MySQL, SQL, DBMS \\

AI \& Machine Learning & Scikit-learn, XGBoost, SMOTE, NLP, ANN \\

Cloud Technologies & AWS Cloud Practitioner, Cloud Fundamentals \\

Software Engineering & OOP, SDLC, DSA, Design Principles \\
...
\begin{rSubsection}{Computer Science \& Applications Faculty (Part-Time)}{}{American Institute}{}
...
\begin{rSection}{Key Strengths}

\item Software Development and Problem Solving

\item Full Stack Web Application Development

\item Machine Learning and Data Analytics
...
\item IEEE Conference Accepted Research Paper in Artificial Intelligence.

\item Participated in 24-hour and 36-hour National Level Hackathons.

\item Developed machine learning models achieving prediction accuracy up to 98.6\%.
